...
private fun solution1(strings : String) =
    strings
        .lines()
        .sumOf { line ->
            val list1 = line.split(": ")

            val gameId = list1[0].removePrefix("Game ").toInt()
            ...
            rounds.forEach { round ->
                ...
                colors.forEach { color ->
                    amountPerColor.forEach { (col, maxAmount) ->
                        ...
                        if (amount != color && amount.toInt() > maxAmount) {
                            return@sumOf 0
                        }
                    }
                }
...
private fun solution2(strings : String) =
    strings
        .lines()
        .sumOf { line ->
            val list1 = line.split(": ")
...
fun main() = println(solution2(input))
